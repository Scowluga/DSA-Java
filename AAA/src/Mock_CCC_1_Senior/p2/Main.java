...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Set<Integer>[] cs = new Set[N];
        Set<Integer>[] hs = new Set[N];
        ...
        for (int r = 0; r < N; r++) {
            ...
            for (int c = 0; c < N; c++) {
                int in = parse(s.substring(c, c+1));
                if (in < 0 || in >= N) {

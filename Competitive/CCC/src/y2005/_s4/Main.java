...
/* Pyramid Message Scheme 10/10pt
 * Graph Theory

Fairly simple problem.
    Original method is just number of nodes
    New method is just height of tree
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (L-- > 0) {
            ...
            for (int i = 0; i < N; i++) in[i] = reader.readLine();
            ...
            int c = 0;
            for (int i = 0; i < N; i++) {
                if (ls.get(ls.size()-2).equals(in[i])) {
                    ls.remove(ls.size()-1);
                } else {
                    ls.add(in[i]);
                }
                c = Math.max(c, ls.size() - 2);
            }
            System.out.println((N - (2*c))*10);
        }
    }

...
//
//        int[] vs = reader.readLineAsIntArray(N, false);
//        int[] as = reader.readLineAsIntArray(N, false);
//
//        for (int i = 0; i < N; i++) {
//            items.add(new Item(vs[i], as[i]));
//        }
//
//        Collections.sort(items);
//
//        // generate a graph somehow then just BFS lol
//        // wtf it's not really DP
    ...
    public static class Item implements Comparable<Item> {
        ...
        public Item(int val, int amount) {
            this.val = val;
            this.amount = amount;
        }
